...
var defaultSettings = {
  ...
  "project_type": "",
  "project_format": "", // Options: "slide" (for scrolly stories). NPR-specific param
...
function generateArtboardDiv(ab, settings) {
  ...
  if (settings.project_format == "slide") {
    // ADDED THIS PARAM FOR NPR
    // we want to make sure the height doesn't go past 100% / don't hard-code in pixel values
